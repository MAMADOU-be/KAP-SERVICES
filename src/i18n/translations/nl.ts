export const nl = {
  ...
  hero: {
    ...
    description: "Kap Services is uw erkend dienstenchequebedrijf in België waarop u kunt vertrouwen. Onze huishoudhulpen zorgen voor een volledig onderhoud van uw woning: schoonmaak, strijken en organisatie.\n\nEen beroep doen op onze diensten betekent kiezen voor zekerheid aan de beste prijs:\n\n· Een voordelig tarief dankzij het systeem van dienstencheques en de fiscale aftrek.\n\n· Geen zwartwerk: u doet een beroep op een wettelijk aangegeven werknemer.\n\n· Volledige veiligheid: ons personeel is volledig verzekerd bij schade of een ongeval.",
    priceHighlight: "",
  ...
  howItWorks: {
    ...
    pricing: {
      ...
      pluxeeLinkUrl: "https://www.pluxee.be/fr/titre-service/",
