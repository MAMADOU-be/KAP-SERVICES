export const en = {
  ...
  about: {
    ...
    certification: {
      ...
      summary: "Discover the testimonial of one of our internal coaches, certified as a company tutor. Since 2020, Kap Services has set up a field coaching and continuous training programme: our coaches support housekeepers on a daily basis with time management, stress, and client relations. After a two-year programme, this official recognition values our teams, strengthens team spirit in an often-isolated profession, and embodies the company's commitment to service quality.",
