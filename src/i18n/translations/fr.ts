export const fr = {
  ...
  hero: {
    ...
    title: "Service d'Aide ménager(e) & repasseuse,",
  ...
  about: {
    ...
    certification: {
      ...
      summary: "Découvrez le témoignage d'une de nos coachs internes, devenue ensuite certifiée « tutrice » en entreprise. Depuis 2020, Kap Services met en place un programme de coaching de terrain et de formation continue : nos coachs accompagnent les aides-ménager.ère.s au quotidien, les soutiennent dans la gestion du temps, du stress et de la relation client.\n\nAfin d'aller encore plus loin, l'entreprise propose à ses travailleurs qui le souhaitent un accompagnement spécifique, réalisé par nos tutrices et coachs en entreprise, pour passer les épreuves de la validation des compétences en collaboration avec le consortium CVDC et le Forem. À l'issue de cette démarche, les travailleurs obtiennent un titre reconnu et une belle preuve de reconnaissance de leur professionnalisme. Cette réussite valorise nos équipes, renforce l'esprit d'équipe dans un métier souvent isolé, et incarne l'engagement de l'entreprise pour la qualité de service.",
